...
理念: 我们学习性能优化的一个核心的理念——用什么工具，怎么用, 不是最重要的，因为所有的工具都存在用法迭代的问题.最重要是优化原理和概念本质

前端工程师首先是软件工程师。对整个技术架构的理解，将会反哺我们对某一具体环节的理解；知识点的适当拓展，也会对我们技术高度和技术广度的提升大有裨益
同一个问题,不同水平的人不同回答. 回答要有结构 体系 和 丰富信息
```
## 前置阅读-资料
