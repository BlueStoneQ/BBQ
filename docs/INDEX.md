...
- [XRN 工程化体系（分 Bundle + 热更新 + 灰度 + CLI）](./interview/root/XRN/README.md)
  - [Q&A（深度问题）](./interview/root/XRN/qa.md)
  - [RN + APK 可观测体系](./interview/root/XRN/observability.md)
  - [RN 工程化深度方案](./interview/root/XRN/rn-engineering-deep.md)
  - [XRN Release Platform](./interview/root/XRN/xrn-release-platform.md)

## RN 知识体系

- [RN 总入口](./interview/root/RN/README.md)
  - [全景（结构→构建→启动→渲染→调 Native）](./interview/root/RN/rn-full-picture.md)
  - [通信（JSI/TurboModule/BLE）](./interview/root/RN/rn-native-communication.md)
...
- [可观测性体系（索引）](./interview/DiDi/observability/README.md)
  ...
  - [RN + APK 可观测](./interview/root/XRN/observability.md)
  - [告警体系 + 发布观测 SOP](./interview/DiDi/observability/alert.md)
...
- [LangChain 理解](./project/AI/langchain-understanding.md)
- [LangGraph 理解](./project/AI/langgraph-understanding.md)

---

## Android / Native

- [RN→CRN→快应用→Android 纵深线](./resume/explain/3.2-xc/rn-native-stack/README.md)
...
- [快应用框架](./interview/LN/quickapp-platform/README.md)
- [Rust+Flutter 卡片引擎](./interview/LN/rust-flutter-card/README.md)
...
- [Java/Kotlin vs TS](./resume/explain/common/java-kotlin-vs-ts.md)
- [C++/Rust vs TS](./resume/explain/common/cpp-rust-vs-ts.md)

## 职业规划

- [能力模型与方向](./futrue/career-model.md)
