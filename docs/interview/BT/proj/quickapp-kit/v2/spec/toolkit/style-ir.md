...
Style property names must be normalized to the Runtime Style Contract. Unsupported properties are errors in strict mode and warnings only when an explicit compatibility policy allows them.
