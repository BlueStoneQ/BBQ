...
# 项目经历
## MI · 小米·手机部·软件部·vela研发部·前端框架部（2024-4~至今）
...
## Trip.com · 携程·机票事业部·机酒终端组：资深工程师（2023-5~2023-9）
...
## XT · XTransfer·技术部·金融产品：前端架构师（2022-12~2023-3）
### 1.XTransfer App（React Native + Android + IOS）
负责团队阻塞点和难点的爆破：
